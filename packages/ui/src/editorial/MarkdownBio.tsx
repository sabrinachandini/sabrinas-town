  ...
  return (
    <div
      className={[
        ...
        "[&_ul_li]:flex [&_ul_li]:gap-3 [&_ul_li]:before:content-['—'] [&_ul_li]:before:text-crimson/50 [&_ul_li]:before:flex-shrink-0 [&_ul_li]:before:font-ui [&_ul_li]:before:text-[20px]",
