    ...
    <main>
      ...
      <section className="bg-ink border-b-4 border-crimson py-12 sm:py-24 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-[1200px] relative">
          ...
          <a href="/" className="no-underline" style={{ color: "#f2ece0", textDecoration: "none" }}>
            <h1
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="font-ui text-[20px] text-ink/60 leading-relaxed">
                    ...
                    war. Use the <Link href="/map">network map</Link> to
