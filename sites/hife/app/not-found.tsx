          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-0 border-t-2 border-[#14100a]">
            {[
              ...
              <NextLink
                key={href}
                href={href}
                className="no-underline flex items-center gap-2 px-4 py-4 border-b border-r border-[rgba(20,16,10,0.12)] last:border-r-0 font-ui text-[12px] text-[#14100a] hover:bg-[#1a3a72] hover:text-[#f2e6c8] transition-colors duration-150 [&:hover_.dot]:bg-[#4A6A9B]"
              >
