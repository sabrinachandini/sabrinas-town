...
const SEQUENCES = [
  {
    ...
    description:
      "The vote for independence on July 2, 1776 was nearly lost when Delaware's delegation was deadlocked — until Caesar Rodney rode through the night to break the tie. Dover was the political center that produced this decisive moment; Wilmington was the commercial port that felt British policy most acutely. Students examine how individual decisions at critical moments can change the course of history.",
  },
];
  ...
  return (
    <div>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#14100a] py-12 sm:py-20 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        <div aria-hidden className="absolute right-[-10px] top-[-20px] font-display leading-none pointer-events-none select-none text-white/[0.04]" style={{ fontSize: "clamp(160px,28vw,360px)", letterSpacing: "-0.05em" }}>DE</div>
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto">
          <nav className="flex items-center gap-2 mb-8">
            ...
            <span className="font-ui text-[11px] uppercase tracking-[0.2em] text-[#f2e6c8]/55">Delaware</span>
          </nav>
          ...
          <h1 className="font-display text-[#f2e6c8] leading-[0.88] tracking-[-0.02em] whitespace-nowrap" style={{ fontSize: "clamp(42px,8vw,120px)" }}>Delaware</h1>
          ...
          <p className="font-editorial italic font-light text-[19px] text-[rgba(255,255,255,0.65)] max-w-[580px] leading-[1.65]">
            Delaware's decision to break with Pennsylvania gave the Continental Congress its key swing vote for independence — the smallest colony with one of the Revolution's most decisive moments.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#cc3322] border-b-4 border-[#14100a] py-10 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        <div aria-hidden className="absolute right-4 top-[-12px] font-display text-[190px] leading-none text-white/[0.06] pointer-events-none select-none">DE</div>
        <div className="relative z-10 flex items-center flex-wrap gap-0 max-w-[1200px] mx-auto">
          {[
            { num: String(DE_TOWNS.length), label: "Towns in Collection" },
      ...
      <section className="bg-[#f2e6c8] border-b-4 border-[#14100a] py-10 sm:py-16 px-5 sm:px-8 md:px-16">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-[1fr_2fr] gap-12">
          <div>
            ...
            <h2 className="font-display text-[#14100a] leading-[0.92]" style={{ fontSize: "clamp(32px,4vw,52px)" }}>Why Teach<br /><span className="text-[#1a3a72]">Delaware?</span></h2>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#cc3322] py-10 sm:py-16 px-5 sm:px-8 md:px-16">
        <div className="max-w-[1200px] mx-auto">
          <p className="font-ui text-[11px] uppercase tracking-[0.28em] text-[#cc3322] flex items-center gap-2.5 mb-4"><span className="w-4 h-[2px] bg-[#cc3322] block" />Recommended Sequence</p>
      ...
      <section className="bg-[#1a3a72] py-10 sm:py-16 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[720px] mx-auto">
          ...
          <p className="font-editorial italic font-light text-[18px] text-[rgba(255,255,255,0.62)] leading-[1.7] mb-8 max-w-[600px]">
            Every source in our Delaware materials is evaluated using a three-tier credibility system. Tier&nbsp;1 includes primary documents, National Park Service materials, and peer-reviewed scholarship. Teacher narratives contextualize sources — they don&apos;t replace them.
          </p>
