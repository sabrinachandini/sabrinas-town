...
export function PageHeader({
  ...
  if (variant === "bold") {
    return (
      ...
      >
        ...
        {subtitle && (
          <p className="font-ui text-[20px] text-[rgba(242,230,200,0.75)] mt-5 leading-relaxed max-w-[600px] relative z-10">
            {subtitle}
          </p>
        )}
        {lastUpdated && (
  ...
  return (
    <header className="mb-16 md:mb-20">
      ...
      {subtitle && (
        <p className="font-ui text-[20px] text-ink/60 mt-5 leading-relaxed max-w-[600px]">
          {subtitle}
        </p>
      )}
      {lastUpdated && (
