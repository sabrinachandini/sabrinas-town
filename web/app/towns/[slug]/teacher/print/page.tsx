  ...
  return (
    <div className="print-page max-w-[800px] mx-auto p-8">
      ...
      <section className="print-section mb-12">
        ...
        {lessonPlan.objectives && (
          <div className="mt-6">
            ...
            <ol className="mt-2 space-y-1 list-decimal list-inside text-sm">
              {(lessonPlan.objectives as string[]).map((o: string, i: number) => <li key={i}>{o}</li>)}
            </ol>
          </div>
        )}
        ...
        {lessonPlan.essentialQuestions && (
          <div className="mt-6">
            ...
            <ul className="mt-2 space-y-1 text-sm">
              {(lessonPlan.essentialQuestions as string[]).map((q: string, i: number) => (
        ...
        {lessonPlan.warmUp && (
          <div className="mt-6">
            <h3 className="text-lg font-semibold">Warm-Up ({(lessonPlan.warmUp as { duration: string }).duration})</h3>
            <p className="mt-1 text-sm">{(lessonPlan.warmUp as { activity: string }).activity}</p>
          </div>
        )}
      </section>
