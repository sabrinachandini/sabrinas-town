                  ...
                  <ul>
                    {Array.from(new Set(events.map((e) => e.month).filter(Boolean) as number[]))
                      ...
                      .map((month) => {
                        ...
                        return (
                          <li key={month}>
                            <a href={`#month-${month}`} className="no-underline flex items-center justify-between py-2.5 border-b border-ink/8 font-ui text-[13px] text-ink hover:text-crimson transition-colors">
          ...
          return (
            ...
            >
              ...
              <div className="flex items-baseline justify-between mb-3">
                <p className={`font-display text-[13px] tracking-[0.04em] ${isCurrent ? "text-crimson" : "text-ink/50"}`}>
                  {MONTH_SHORT[month]}
                </p>
                {isCurrent && (
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="font-ui text-[13px] text-ink/70 leading-relaxed">{event.description}</p>
