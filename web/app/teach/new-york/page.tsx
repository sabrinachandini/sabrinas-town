...
export const metadata: Metadata = {
  ...
  description:
    "Teacher resources for New York towns at the strategic center of the American Revolution. Curated lesson plans, primary sources, and classroom assessments.",
  openGraph: {
    title: "Teach New York | History is for Everyone",
    description:
      "Teacher resources for New York towns at the strategic center of the American Revolution. Curated lesson plans, primary sources, and classroom assessments.",
...
const SEQUENCES = [
  {
    title: "The 1776 Collapse",
    towns: ["New York City", "Harlem Heights", "White Plains"],
  ...
  {
    title: "The Hudson River Highlands",
    towns: ["West Point", "Kingston", "Newburgh"],
  ...
  {
    title: "The Road to Saratoga",
    towns: ["Crown Point", "Ticonderoga", "Saratoga Springs"],
    ...
    <div>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#14100a] py-12 sm:py-20 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        <div
          ...
          style={{ fontSize: "clamp(160px,28vw,360px)", letterSpacing: "-0.05em" }}
        >
          NY
        </div>
        ...
        <div
          aria-hidden
          className="absolute top-10 right-10 rotate-[-2.5deg] font-ui font-bold text-[10px] tracking-[0.12em] uppercase text-[rgba(242,230,200,0.5)] border-[2px] border-[rgba(242,230,200,0.35)] px-3 py-1.5 hidden sm:block"
        >
          For Classrooms
        </div>
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto">
          <nav className="flex items-center gap-2 mb-8">
            ...
            <span className="font-ui text-[11px] uppercase tracking-[0.2em] text-[#f2e6c8]/55">New York</span>
          </nav>
          ...
          <svg width="320" height="12" viewBox="0 0 320 12" className="block mt-6 mb-8" aria-hidden>
            <path
              d="M0 8 Q20 2 40 8 Q60 14 80 7 Q100 1 120 7 Q140 13 160 7 Q180 2 200 7 Q220 13 240 7 Q260 2 280 7 Q300 13 320 6"
          ...
          <p className="font-editorial italic font-light text-[19px] text-[rgba(255,255,255,0.65)] max-w-[580px] leading-[1.65]">
            New York was the strategic prize of the entire war — British-held New York City,
            the turning-point at Saratoga, and a Hudson Valley that Washington fought seven
            years to control.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#cc3322] border-b-4 border-[#14100a] py-10 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center flex-wrap gap-0 max-w-[1200px] mx-auto">
          {[
            { num: String(NY_TOWNS.length), label: "Towns in Collection" },
      ...
      <section className="bg-[#f2e6c8] border-b-4 border-[#14100a] py-10 sm:py-16 px-5 sm:px-8 md:px-16">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-[1fr_2fr] gap-12">
          <div>
            ...
            <h2 className="font-display text-[#14100a] leading-[0.92]" style={{ fontSize: "clamp(32px,4vw,52px)" }}>
              Why Teach<br />
              <span className="text-[#1a3a72]">New York?</span>
            </h2>
          ...
          <div className="space-y-5">
            <p className="font-editorial italic font-light text-[18px] text-[#14100a]/70 leading-[1.75]">
              No state offers students a fuller picture of the war's complexity. New York City under British
            ...
            <p className="font-ui text-[20px] text-[#14100a]/60 leading-relaxed">
              ...
              collection span that full arc: from catastrophic defeat to cautious triumph.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#cc3322] py-10 sm:py-16 px-5 sm:px-8 md:px-16">
        <div className="max-w-[1200px] mx-auto">
          ...
          <h2 className="font-display text-[#f2e6c8] leading-[0.92] mb-10" style={{ fontSize: "clamp(32px,4vw,52px)" }}>
            Multi-Town Teaching Sequences
          </h2>
            ...
            {modules.map((m, i) => (
              <div key={m.slug} className="flex items-center justify-between py-6 border-b border-[#14100a]/10 gap-8 group">
                <div className="flex items-center gap-5 min-w-0">
                  <span className="font-ui text-[10px] font-semibold text-[#14100a]/25 w-6 flex-shrink-0 text-right">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                  <div className="min-w-0">
                    <a
                      href={`/towns/${m.slug}/teacher`}
                      className="no-underline font-display text-[clamp(22px,3vw,32px)] text-[#14100a] hover:text-[#cc3322] transition-colors leading-none tracking-[-0.02em]"
                    >
                      {m.name}
                    </a>
                    {m.gradeRange && (
                      <p className="font-ui text-[10px] uppercase tracking-[0.14em] text-[#14100a]/35 mt-1">
                        {m.gradeRange}{m.duration ? ` · ${m.duration}` : ""}
                      </p>
                    )}
                  </div>
                </div>
      ...
      <section className="bg-[#1a3a72] py-10 sm:py-16 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[720px] mx-auto">
          ...
          <p className="font-editorial italic font-light text-[18px] text-[rgba(255,255,255,0.62)] leading-[1.7] mb-8 max-w-[600px]">
            Every source in our New York materials is evaluated using a three-tier credibility system.
            Tier&nbsp;1 includes primary documents, National Park Service materials, and peer-reviewed
            scholarship. Teacher narratives contextualize sources — they don&apos;t replace them.
          </p>
          <div className="flex gap-6 flex-wrap">
            <a href="/methodology" className="no-underline font-ui text-[10px] uppercase tracking-[0.18em] text-[#f2e6c8]/40 border-b border-[#f2e6c8]/20 pb-0.5 hover:text-[#f2e6c8] hover:border-[#f2e6c8]/50 transition-colors">
              Read Our Full Methodology
            </a>
            <a href="/teach" className="no-underline font-ui text-[10px] uppercase tracking-[0.18em] text-[#f2e6c8]/40 border-b border-[#f2e6c8]/20 pb-0.5 hover:text-[#f2e6c8] hover:border-[#f2e6c8]/50 transition-colors">
              All States →
            </a>
          </div>
        </div>
