...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Teacher resources for Connecticut towns in the American Revolution. Curated lesson plans, primary sources, and classroom assessments.",
    url: "https://sabrinas-town.vercel.app/teach/connecticut",
  },
  alternates: { canonical: "https://sabrinas-town.vercel.app/teach/connecticut" },
};
...
const SEQUENCES = [
  {
    title: "The 1781 Coastal Raids",
    towns: ["New London", "Groton"],
  ...
  {
    title: "Connecticut's Home Front",
    towns: ["Danbury", "New Haven"],
    duration: "3–4 class periods",
    description:
    ...
    <div>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#14100a] py-12 sm:py-20 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto">
          ...
          <p className="font-editorial italic font-light text-[19px] text-[rgba(255,255,255,0.65)] max-w-[580px] leading-[1.65]">
            Connecticut's Revolutionary story spans maritime economy, Tory loyalists, coastal raids,
            and the Provisions State that fed the Continental Army through seven years of war.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#cc3322] border-b-4 border-[#14100a] py-10 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center flex-wrap gap-0 max-w-[1200px] mx-auto">
          {[
            { num: String(CT_TOWNS.length), label: "Towns in Collection" },
        ...
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-[1fr_2fr] gap-12">
          <div>
            ...
            <h2 className="font-display text-[#14100a] leading-[0.92]" style={{ fontSize: "clamp(32px,4vw,52px)" }}>
              Why Teach<br />
              <span className="text-[#1a3a72]">Connecticut?</span>
            </h2>
          ...
          <div className="space-y-5">
            <p className="font-editorial italic font-light text-[18px] text-[#14100a]/70 leading-[1.75]">
              Connecticut earned the nickname "the Provisions State" because its farms, foundries, and
            ...
            <p className="font-ui text-[20px] text-[#14100a]/60 leading-relaxed">
              ...
              personal terms. Teaching Connecticut means teaching how communities that disagreed
              about revolution ultimately decided what they were willing to sacrifice.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#1a3a72] py-10 sm:py-16 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[720px] mx-auto">
          ...
          <p className="font-editorial italic font-light text-[18px] text-[rgba(255,255,255,0.62)] leading-[1.7] mb-8 max-w-[600px]">
            Every source in our Connecticut materials is evaluated using a three-tier credibility system.
