      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#14100a] py-20 px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto">
          <nav className="flex items-center gap-2 mb-8">
            ...
            <span className="font-ui text-[9px] uppercase tracking-[0.2em] text-[#f2e6c8]/55">Virginia</span>
          </nav>
      ...
      <section className="bg-[#cc3322] border-b-4 border-[#14100a] py-10 px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center flex-wrap gap-0 max-w-[1200px] mx-auto">
          ...
          <div className="ml-auto">
            <div className="bg-[#f2e6c8] text-[#14100a] font-ui text-[9px] font-bold tracking-[0.22em] uppercase px-5 py-2.5 border-[2.5px] border-[#14100a] inline-block" style={{ boxShadow: "3px 3px 0 #14100a", transform: "rotate(-2deg)" }}>
              Standards Aligned
            </div>
          </div>
        </div>
            ...
            {modules.map((m, i) => (
              <div key={m.slug} className="flex items-center justify-between py-6 border-b border-[#14100a]/10 gap-8 group">
                ...
                <div className="flex items-center gap-4 flex-shrink-0">
                  ...
                  {m.hasModule && (
                    <a href={`/towns/${m.slug}/teacher/print`} target="_blank" rel="noopener noreferrer" className="no-underline font-ui text-[9px] uppercase tracking-[0.16em] text-[#cc3322] border border-[#cc3322]/30 px-4 py-2 hover:bg-[#cc3322] hover:text-[#f2e6c8] transition-colors whitespace-nowrap">
                      Print →
                    </a>
                  )}
                </div>
