...
const SEQUENCES = [
  {
    title: "Capital and Revolution",
    towns: ["Williamsburg", "Richmond"],
  ...
  {
    title: "Washington's Virginia",
    towns: ["Alexandria", "Mount Vernon", "Fredericksburg"],
  ...
  },
  {
    ...
    towns: ["Charlottesville", "Yorktown"],
    duration: "3–5 class periods",
    description:
  ...
  return (
    <div>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#14100a] py-12 sm:py-20 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div aria-hidden className="absolute top-10 right-10 rotate-[-2.5deg] font-ui font-bold text-[10px] tracking-[0.12em] uppercase text-[rgba(242,230,200,0.5)] border-[2px] border-[rgba(242,230,200,0.35)] px-3 py-1.5 hidden sm:block">
          For Classrooms
        </div>
        <div className="relative z-10 max-w-[1200px] mx-auto">
          <nav className="flex items-center gap-2 mb-8">
            ...
            <span className="font-ui text-[11px] uppercase tracking-[0.2em] text-[#f2e6c8]/55">Virginia</span>
          </nav>
          ...
          <h1 className="font-display text-[#f2e6c8] leading-[0.88] tracking-[-0.02em] whitespace-nowrap" style={{ fontSize: "clamp(42px,8vw,120px)" }}>
            Virginia
          </h1>
      ...
      <section className="bg-[#cc3322] border-b-4 border-[#14100a] py-10 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        <div aria-hidden className="absolute right-4 top-[-12px] font-display text-[190px] leading-none text-white/[0.06] pointer-events-none select-none">VA</div>
        <div className="relative z-10 flex items-center flex-wrap gap-0 max-w-[1200px] mx-auto">
          {[
            { num: String(VA_TOWNS.length), label: "Towns in Collection" },
          ...
          <div className="ml-auto">
            <div className="bg-[#f2e6c8] text-[#14100a] font-ui text-[11px] font-bold tracking-[0.22em] uppercase px-5 py-2.5 border-[2.5px] border-[#14100a] inline-block" style={{ boxShadow: "3px 3px 0 #14100a", transform: "rotate(-2deg)" }}>
              Standards Aligned
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-[1fr_2fr] gap-12">
          <div>
            <p className="font-ui text-[11px] uppercase tracking-[0.28em] text-[#cc3322] flex items-center gap-2.5 mb-4">
              <span className="w-4 h-[2px] bg-[#cc3322] block" />The Context
            </p>
            <h2 className="font-display text-[#14100a] leading-[0.92]" style={{ fontSize: "clamp(32px,4vw,52px)" }}>
              Why Teach<br /><span className="text-[#1a3a72]">Virginia?</span>
            </h2>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#cc3322] py-10 sm:py-16 px-5 sm:px-8 md:px-16">
        <div className="max-w-[1200px] mx-auto">
          <p className="font-ui text-[11px] uppercase tracking-[0.28em] text-[#cc3322] flex items-center gap-2.5 mb-4">
            <span className="w-4 h-[2px] bg-[#cc3322] block" />Recommended Sequences
          </p>
            ...
            {modules.map((m, i) => (
              <div key={m.slug} className="flex items-center justify-between py-6 border-b border-[#14100a]/10 gap-8 group">
                ...
                <div className="flex items-center gap-4 flex-shrink-0">
                  ...
                  {m.hasModule && (
                    <a href={`/towns/${m.slug}/teacher/print`} target="_blank" rel="noopener noreferrer" className="no-underline font-ui text-[11px] uppercase tracking-[0.16em] text-[#cc3322] border border-[#cc3322]/30 px-4 py-2 hover:bg-[#cc3322] hover:text-[#f2e6c8] transition-colors whitespace-nowrap">
                      Print →
                    </a>
                  )}
                </div>
