  ...
  return (
    <main>
      ...
      <section className="py-section">
        <Container>
          <Heading level={1}>Virginia</Heading>
          <div className="mt-element max-w-[720px] space-y-element">
            <Text>
              Virginia produced the Revolution&apos;s most consequential leaders
              — Washington, Jefferson, Madison, Henry — and its final chapter
              was written at Yorktown, where the last major British army
              surrendered in 1781.
            </Text>
            <Text>
