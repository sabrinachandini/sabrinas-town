...
const GA_TOWNS = [
  { slug: "savannah-ga", name: "Savannah" },
  { slug: "augusta-ga", name: "Augusta" },
];

const SEQUENCES = [
  {
    title: "Occupation and Liberation",
    towns: ["Savannah", "Augusta"],
...
export default async function GeorgiaTeachPage() {
  const modules = await Promise.all(
    GA_TOWNS.map(async (town) => {
  ...
  return (
    <div>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#14100a] py-12 sm:py-20 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        <div aria-hidden className="absolute right-[-10px] top-[-20px] font-display leading-none pointer-events-none select-none text-white/[0.04]" style={{ fontSize: "clamp(160px,28vw,360px)", letterSpacing: "-0.05em" }}>GA</div>
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto">
          <nav className="flex items-center gap-2 mb-8">
            ...
            <span className="font-ui text-[11px] uppercase tracking-[0.2em] text-[#f2e6c8]/55">Georgia</span>
          </nav>
          ...
          <h1 className="font-display text-[#f2e6c8] leading-[0.88] tracking-[-0.02em] whitespace-nowrap" style={{ fontSize: "clamp(42px,8vw,120px)" }}>Georgia</h1>
      ...
      <section className="bg-[#cc3322] border-b-4 border-[#14100a] py-10 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        <div aria-hidden className="absolute right-4 top-[-12px] font-display text-[190px] leading-none text-white/[0.06] pointer-events-none select-none">GA</div>
        <div className="relative z-10 flex items-center flex-wrap gap-0 max-w-[1200px] mx-auto">
          {[
            { num: String(GA_TOWNS.length), label: "Towns in Collection" },
      ...
      <section className="bg-[#f2e6c8] border-b-4 border-[#14100a] py-10 sm:py-16 px-5 sm:px-8 md:px-16">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-[1fr_2fr] gap-12">
          <div>
            ...
            <h2 className="font-display text-[#14100a] leading-[0.92]" style={{ fontSize: "clamp(32px,4vw,52px)" }}>Why Teach<br /><span className="text-[#1a3a72]">Georgia?</span></h2>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#cc3322] py-10 sm:py-16 px-5 sm:px-8 md:px-16">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-1 gap-px bg-[#f2e6c8]/5 max-w-[600px]">
            {SEQUENCES.map((seq) => (
