    ...
    <div>
      ...
      <section className="bg-[#1a3a72] border-b-4 border-[#14100a] py-12 sm:py-20 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto">
          ...
          <nav className="flex items-center gap-2 mb-8">
            ...
            <span className="font-ui text-[11px] uppercase tracking-[0.2em] text-[#f2e6c8]/55">Massachusetts</span>
          </nav>
          ...
          <p className="font-editorial italic font-light text-[19px] text-[rgba(255,255,255,0.65)] max-w-[580px] leading-[1.65]">
            Massachusetts is where the American Revolution became irreversible — from the shots at
            Lexington and Concord to the siege of Boston, ten towns that capture the full arc of
            colonial resistance becoming armed revolt.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#cc3322] border-b-4 border-[#14100a] py-10 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center flex-wrap gap-0 max-w-[1200px] mx-auto">
          {[
            { num: String(MA_TOWNS.length), label: "Towns in Collection" },
            ...
            >
              <div
                className="font-display text-[#4A6A9B] leading-none"
              ...
              <svg width="50" height="7" viewBox="0 0 50 7" aria-hidden className="mt-1">
                <path
                  d="M0 4 Q6 1 12 4 Q18 7 25 3 Q31 0 37 3 Q43 7 50 2"
                  stroke="#4A6A9B"
                  strokeWidth="1.5"
                  fill="none"
                  strokeLinecap="round"
      ...
      <section className="bg-[#f2e6c8] border-b-4 border-[#14100a] py-10 sm:py-16 px-5 sm:px-8 md:px-16">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-[1fr_2fr] gap-12">
          <div>
            ...
            >
              Why Teach<br />
              <span className="text-[#1a3a72]">Massachusetts?</span>
            </h2>
          ...
          <div className="space-y-5">
            <p className="font-editorial italic font-light text-[18px] text-[#14100a]/70 leading-[1.75]">
              The ten towns in this collection represent the geography of that transformation. Lexington
            ...
            <p className="font-ui text-[16px] text-[#14100a]/60 leading-relaxed">
              ...
              present. Each town offers students a different angle on the same fundamental question:
              how does a society decide to break with its government?
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-px bg-[#f2e6c8]/5">
            {SEQUENCES.map((seq) => (
              <div key={seq.title} className="bg-[#1a3a72] p-7 border border-[#f2e6c8]/8">
                ...
                <h3
                  className="font-display text-[#f2e6c8] leading-tight mb-4"
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="border-t-[3px] border-[#14100a]">
            {modules.map((m, i) => (
              <div
                key={m.slug}
                className="flex items-center justify-between py-6 border-b border-[#14100a]/10 gap-8 group"
              >
      ...
      <section className="bg-[#1a3a72] py-10 sm:py-16 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[720px] mx-auto">
          ...
          <h2
            className="font-display text-[#f2e6c8] leading-[0.9] mb-6"
            style={{ fontSize: "clamp(36px,5vw,68px)" }}
          >
            Tier&nbsp;1{" "}
            <span
              className="text-[#4A6A9B] inline-block"
          ...
          <p className="font-editorial italic font-light text-[18px] text-[rgba(255,255,255,0.62)] leading-[1.7] mb-8 max-w-[600px]">
            Every source in our Massachusetts materials is evaluated using a three-tier credibility
            system. Tier&nbsp;1 includes primary documents, National Park Service materials, and
            peer-reviewed scholarship. Teacher narratives contextualize sources — they don&apos;t
            replace them.
          </p>
          <div className="flex gap-6 flex-wrap">
            <a
              href="/methodology"
              className="no-underline font-ui text-[10px] uppercase tracking-[0.18em] text-[#f2e6c8]/40 border-b border-[#f2e6c8]/20 pb-0.5 hover:text-[#f2e6c8] hover:border-[#f2e6c8]/50 transition-colors"
            >
