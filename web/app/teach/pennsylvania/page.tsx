...
const SEQUENCES = [
  {
    title: "The Philadelphia Campaign",
    towns: ["Paoli", "Germantown", "Philadelphia"],
  ...
  return (
    <div>
      ...
      <section className="bg-[#cc3322] border-b-4 border-[#14100a] py-10 px-5 sm:px-8 md:px-16 relative overflow-hidden">
        <div aria-hidden className="absolute right-4 top-[-12px] font-display text-[190px] leading-none text-white/[0.06] pointer-events-none select-none">PA</div>
        <div className="relative z-10 flex items-center flex-wrap gap-0 max-w-[1200px] mx-auto">
          {[
            { num: String(PA_TOWNS.length), label: "Towns in Collection" },
